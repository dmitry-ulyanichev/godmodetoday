...
- **Palabra del Dia Solver:** The app helps guess the word of the day provided by a popular third-party application.
    ...
    - **In addition to the onscreen instructions, the row on which an action is to be performed should be highlighted with animation: each cell should jump and down a little bit one after another in a wavelike pattern.**
